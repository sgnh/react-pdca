  ...
  <svg width={width} height={height} style={style} viewBox="0 0 200 200" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
    ...
    <g id="PDCA">
      ...
      <g
        id="Do"
        onClick={onDoClick}
        style={{ cursor: onDoClick ? 'pointer' : undefined }}
      >
        <path
          id="DoSlice"
      ...
      <g
        ...
        style={{ cursor: onCheckClick ? 'pointer' : undefined }}
      >
        <path
          id="CheckSlice"
      ...
      <g
        id="Act"
        onClick={onActClick}
        style={{ cursor: onActClick ? 'pointer' : undefined }}
      >
        <path
          id="ActSlice"
    ...
    <g id="Shadow" style={{ pointerEvents: 'none' }} fillOpacity="1" fill="black">
